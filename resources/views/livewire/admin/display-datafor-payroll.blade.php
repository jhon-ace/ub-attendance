<div class="mb-4">
    ...
    <div class="flex justify-between mb-4 sm:-mt-4">
        <div class="font-bold text-md tracking-tight text-md text-black mt-2 uppercase">Admin / Employee Attendance for Payroll </div>
    </div>
            ...
            <div x-data="{ tab: 'time-in-time-out' }" class="p-4">
                <div class="overflow-x-auto">
                    ...
                    <div class="flex mb-4">
                        ...
                        >
                            Department Final Computation of Work Hours
                        </button>
                    </div>
                    <div x-show="tab === 'time-in-time-out'" class="w-full">
                        @if($employees->isEmpty())
                            <div class="flex justify-center">
                                <p class="text-black text-sm mt-11 mb-4 uppercase text-center mx-auto">No Employees</p>
                            </div>
                        @endif                                           
                        <div class="flex justify-between p-4">
                            <div class="w-[48%]">
                                ...
                                <div class="text-sm  appearance-none  rounded text-black md:w-auto">
                                    @if($employees->isNotEmpty())
                                        @foreach($employees as $employee)
                                            <div class="mb-6">
                                                <h2 class="font-bold text-lg mb-2">
                                                    {{ $employee->employee_id }} - {{ $employee->employee_lastname }}, {{ $employee->employee_firstname }} {{ ucfirst($employee->employee_middlename) }}
                                                </h2>

                                                @php
                                                    $attendanceTimeInForEmployee = $attendanceTimeIn->where('employee_id', $employee->id);
                                                    $attendanceTimeOutForEmployee = $attendanceTimeOut->where('employee_id', $employee->id);
                                                @endphp

                                                @if ($attendanceTimeInForEmployee->isNotEmpty())
                                                    @php
                                                        $currentDate = null;
                                                    @endphp
                                                    @foreach ($attendanceTimeInForEmployee as $attendanceIn)
                                                        @php
                                                        ...
                                                        @if ($date !== $currentDate)
                                                            ...
                                                            <table class="table-auto min-w-full text-center text-sm mb-4 divide-y divide-gray-200">
                                                                <thead class="bg-gray-200 text-black">
                                                                    <tr>
                                                                        <th class="border border-gray-400 px-3">Emp ID</th>
                                                                        <th class="border border-gray-400 px-3">Date</th>
                                                                        <th class="border border-gray-400 px-3">Time - In</th>
                                                                        <th class="border border-gray-400 px-3">Status</th>
                                                                        <th class="border border-gray-400 px-3">Action</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                        @endif
                                                                    <tr class="hover:bg-gray-100">
                                                                        ...
                                                                        <td class="text-black border border-gray-400 px-1 py-1">{{ ucfirst($attendanceIn->modification_status) }}</td>
                                    ...
                                    @if($employees->isNotEmpty())
                                        @foreach($employees as $employee)
                                            <div class="mb-6">
                                                ...
                                                @if ($attendanceTimeOutForEmployee->isNotEmpty())
                                                    @php
                                                        $currentDate = null;
                                                    @endphp
                                                    @foreach ($attendanceTimeOutForEmployee as $attendanceOut)
                                                        @php
                                                            $checkOutTime = strtotime($attendanceOut->check_out_time);
                                                            $date = date('m-d-Y', $checkOutTime);
                                                            $category = date('A', $checkOutTime); // AM or PM
                                                        @endphp
                                                        @if ($date !== $currentDate)
                                                            @php
                                                                $currentDate = $date;
                                                            ...
                                                            <table class="table-auto min-w-full text-center text-sm mb-4 divide-y divide-gray-200">
                                                                <thead class="bg-gray-200 text-black">
                                                                    <tr>
                                                                        <th class="border border-gray-400 px-3">Emp ID</th>
                                                                        <th class="border border-gray-400 px-3">Date</th>
                                                                        <th class="border border-gray-400 px-3">Time - Out</th>
                                                                        <th class="border border-gray-400 px-3">Status</th>
                                                                        <th class="border border-gray-400 px-3">Action</th>
                                                                    </tr>
                                                                </thead>
                                                        ...
                                                        @endif
                                                                    <tr class="hover:bg-gray-100">
                                                                        ...
                                                                        <td class="text-black border border-gray-400">{{ date('m-d-Y (l)', strtotime($attendanceOut->check_out_time)) }}</td>
                                                                        <td class="text-black border border-gray-400 uppercase">
                                                                            @php
                                                                        ...
                                                                        <td class="text-black border border-gray-400 px-1 py-1">{{ ucfirst($attendanceOut->modification_status) }}</td>
                                                                        <td class="text-black border border-gray-400 px-1 py-1">
                                                                            <div class="flex justify-center items-center space-x-2">
                                                                                <div x-data="{ open: false }">
                                                                                    <a @click="open = true" class="cursor-pointer bg-blue-500 text-white text-sm px-2 py-1 rounded hover:bg-blue-700">
                                ...
                                @foreach ($employees as $employee)                                   
                                        ...
                                        <table class="table-auto min-w-full text-center text-xs mb-4 divide-y divide-gray-200">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($attendanceForEmployee as $attendance)
                                                <tr>
                                            ...
                                            @foreach($employees as $employeeId => $employeeData)
                                                @php
                                                    ...
                                                    $absentFormatted = 
                                                        ...
                                                        ($absentSeconds > 0 ? "{$absentSeconds} sec" : ($absentHours <= 0 && $absentMinutes <= 0 ? '0 sec' : ''));
