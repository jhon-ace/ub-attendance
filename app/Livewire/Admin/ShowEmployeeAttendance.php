...
class ShowEmployeeAttendance extends Component
{
    ...
    public function render()
    {
        ...
        // $TimeInSearch = $this->applySearchFilters($queryTimeIn);
...
public function updateAttendanceByDateRange()
{
    ...
    //                 ->where('employee_lastname', 'like', '%' . $this->search . '%')
    //                 ->where('employee_firstname', 'like', '%' . $this->search . '%')
    //                 ->where('employee_middlename', 'like', '%' . $this->search . '%');
    //     });
    // }
}